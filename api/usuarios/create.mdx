---
title: "POST /usuarios/create — Register a New User"
sidebarTitle: "POST /create"
description: "Register a new user by providing nombre, email, password_hash, and rol. Email must be unique; a duplicate triggers a 400 error with type email-alredy-exist."
---
