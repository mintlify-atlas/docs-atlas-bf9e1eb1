---
title: "DELETE /reserva/eliminar/{id} — Cancel and Remove a Reservation"
sidebarTitle: "DELETE /eliminar"
description: "Delete a reservation by its integer ID. Returns a plain text success message. Throws a 500 error if the ID does not exist."
---
