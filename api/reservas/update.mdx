...
<ParamField body="id" type="integer">
  The reservation ID. This mirrors the path parameter and is carried in the `UpdateReservaRequest` DTO. Both must reference the same reservation.
</ParamField>
