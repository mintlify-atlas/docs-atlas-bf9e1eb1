...
description: "Learn how to run the CoworkingBooking API locally, create a user, register a coworking space, and make your first booking in six guided steps."
---
...
<Steps>
  ...
  <Step title="Update a reservation's status">
